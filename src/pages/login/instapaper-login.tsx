    ...
    return (
        <>
            ...
            <main className={"min-h-screen flex"}>
                {isErrorOpen ?
                    <div id="toast-danger"
                         className="absolute z-10 top-2 right-2 flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                         role="alert">
                        <div
                            className="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200">
                        ...
                        <div className="ml-3 text-sm font-normal">There was an error trying to Signin</div>
                        <button type="button"
